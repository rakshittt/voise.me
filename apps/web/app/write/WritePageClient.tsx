...
import { saveToolHandoff } from "@/lib/toolHandoff";
...
const RELATED_TOOLS = getRelatedTools("/write");
...
export function WritePageClient() {
  ...
  function handleSignUp() {
    if (content.trim()) saveToolHandoff(content, "write", "idea");
    router.push("/sign-up");
  }
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: C.canvas, fontFamily: FONT.body }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", height: 56, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <Link href="/tools" style={{ fontSize: 13, color: C.muted, textDecoration: "none", padding: "6px 12px" }}>
              Free tools
            </Link>
            {user ? (
              <Link
              ...
              <>
                ...
                <button
                  ...
                  style={{ fontSize: 13, fontWeight: 600, color: "#fff", backgroundColor: C.brand, border: "none", cursor: "pointer", padding: "7px 16px", borderRadius: 20 }}
                >
                  Get started free
                </button>
              </>
          ...
          <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: "#fff", color: C.brand, border: "none", cursor: "pointer",
                fontFamily: FONT.body, fontSize: 15, fontWeight: 700,
                letterSpacing: "-0.01em",
              }}
            >
              {content.trim() ? "Generate this in my voice →" : "Get started free →"}
            </button>
          </div>
        </div>
      )}
      ...
      {/* ── More free tools ── */}
      <div style={{ padding: "48px 24px", borderTop: `1px solid ${C.hairline}` }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <p style={{ margin: "0 0 16px", fontFamily: FONT.mono, fontSize: 11, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: C.faint }}>
            More free tools
          </p>
          <div className="write-related-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
            {RELATED_TOOLS.map((tool) => (
              ...
              >
                <p style={{ margin: "0 0 4px", fontSize: 14, fontWeight: 600, color: C.ink, fontFamily: FONT.body }}>
                  {tool.title} →
                </p>
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .write-related-grid { grid-template-columns: 1fr 1fr !important; }
        }
        @media (max-width: 480px) {
          .write-related-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </div>
  );
